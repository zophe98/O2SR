...
# dataset options
__C.dataset = edict()
__C.dataset.name = 'msrvtt-qa' # ['tgif-qa', 'msrvtt-qa', 'msvd-qa']
...
__C.dataset.question_dir = '*/datasets/output/msrvtt-qa'
...
__C.dataset.feat_dir='*/Datasets/VQA/MSRVTT-QA/output'
__C.dataset.feat_pt='{}.pkl'
__C.dataset.save_dir='*/Datasets/VQA/MSRVTT-QA/exp_logs'
