...
__C.dataset.question_dir = '*/datasets/output/tgif-qa'
...
__C.dataset.feat_dir='*/Datasets/VQA/TGIF_QA/output'
__C.dataset.feat_pt='{}.pkl'
__C.dataset.save_dir='*/VQA/TGIF_QA/exp_logs'
