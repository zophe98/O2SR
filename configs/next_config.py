...
# test
__C.test = edict()
__C.test.flag = True           # Default false because test data is not avaliable publicly
...
# dataset options
__C.dataset = edict()
__C.dataset.name = 'next-qa' # ['tgif-qa', 'msrvtt-qa', 'msvd-qa', 'next-qa']
__C.dataset.type = 'both' # '2d', '3d', 'both'
__C.dataset.source = 'gnn_new2'
__C.dataset.num_object = 5  # 10 or 5
__C.dataset.max_video_len = 35 # 80 or 35
__C.dataset.sampled_frame = 10 # 10 or 35

__C.dataset.question_type = 'action' #['frameqa', 'count', 'transition', 'action', 'none']
__C.dataset.question_dir = '*/datasets/output/next-qa'
...
__C.dataset.feat_dir='*/Datasets/VQA/NEXT-QA/output'
__C.dataset.feat_pt='{}.pkl'
__C.dataset.save_dir='*/VQA/NEXT_QA/exp_logs'
